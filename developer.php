...
<html>
  <head>
    <title><?php echo $tle = 'Developer'; ?></title>
...
<div class="main_wrapper-s">
  <div class="main_LFT-a">
    ...
    <div class="top_panel_s"><?php echo $hdB_N; ?></div>
      ...
      <nav id="nav-sb" class="primary clearfix">
        <ul id="nav">
          <li><a>Developer <span class="nav-drop flashit">&#8269;</span></a>
            <ul>
              <li><a href="#goals">goals</a></li>
              <li><a href="#join">join team</a></li>
            </ul>
          </li>
          <li><a>Updates <span class="nav-drop flashit">&#8269;</span></a>
            <ul>
  ...
  <div class="main_CNTR-a">
    <div class="set_view">
      <?php include_once("php_includes/content/devCnt.php"); ?>
    </div><!-- tab end -->
  </div>
  <?php
